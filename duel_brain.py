...
class BrainDQN:
    ...
    def get_action(self, observation):
        ...
        if np.random.uniform() < self.epsilon:  # choosing action
            ...
            tf.summary.histogram("chosen_action", action)
        else:
    ...
    def learn(self):
        try:
            ...
            #     tf.summary.scalar("q_eval_attack", q_eval_a[i])
            #     tf.summary.scalar("q_eval_defence", q_eval_d[i])
                # tf.summary.histogram("reward_attack", int(reward_a[i] * REWARD_MAX))
                # tf.summary.histogram("reward_defence", int(reward_d[i] * REWARD_MAX))
